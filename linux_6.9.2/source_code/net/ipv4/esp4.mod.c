...
SYMBOL_CRC(esp_output_head, 0x00417586, "_gpl");
SYMBOL_CRC(esp_output_tail, 0x38916c68, "_gpl");
SYMBOL_CRC(esp_input_done2, 0x1eb20cf9, "_gpl");
...
MODULE_INFO(srcversion, "4C9E80ED7F4A5EFC06F5EDE");
