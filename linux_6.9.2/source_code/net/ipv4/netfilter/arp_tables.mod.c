...
SYMBOL_CRC(arpt_alloc_initial_table, 0xba005b23, "_gpl");
SYMBOL_CRC(arpt_unregister_table_pre_exit, 0xa3f374b8, "");
SYMBOL_CRC(arpt_register_table, 0xdf54975e, "");
SYMBOL_CRC(arpt_unregister_table, 0xffac9fd5, "");
SYMBOL_CRC(arpt_do_table, 0x36791363, "");
...
MODULE_INFO(srcversion, "FB83C357E4F7C98568031D8");
