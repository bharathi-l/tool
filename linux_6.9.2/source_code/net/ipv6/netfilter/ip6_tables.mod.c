...
SYMBOL_CRC(ip6t_alloc_initial_table, 0x9ce490ae, "_gpl");
SYMBOL_CRC(ip6t_register_table, 0xb21a46f7, "");
SYMBOL_CRC(ip6t_unregister_table_pre_exit, 0xede199c6, "");
SYMBOL_CRC(ip6t_unregister_table_exit, 0xfb7c09a6, "");
SYMBOL_CRC(ip6t_do_table, 0x09ebe341, "");
...
MODULE_INFO(srcversion, "FC340A0069BB1E6CFD12CE4");
