...
#SYMVER sk_ns_capable 0xf7b3fc5e
#SYMVER sk_capable 0x8afd1a4b
#SYMVER sk_net_capable 0x088ac226
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER memalloc_socks_key 0x77ecf68d
#SYMVER sk_set_memalloc 0x46a14cf4
#SYMVER sk_clear_memalloc 0x3ff8bd9e
#SYMVER __sk_backlog_rcv 0x24443389
#SYMVER sk_error_report 0x87a132ef
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0xbaf18ed0
#SYMVER sock_queue_rcv_skb_reason 0x136b25da
#SYMVER __sk_receive_skb 0x21c148f4
#SYMVER __sk_dst_check 0x7ca0d2a2
#SYMVER sk_dst_check 0x2c0d491a
#SYMVER sock_bindtoindex 0x01622bd4
#SYMVER sk_mc_loop 0x4d263588
#SYMVER sock_set_reuseaddr 0x7e2dfb94
#SYMVER sock_set_reuseport 0x2c0fb196
#SYMVER sock_no_linger 0x055b31ea
#SYMVER sock_set_priority 0xf92e2aa1
#SYMVER sock_set_sndtimeo 0x78894479
#SYMVER sock_enable_timestamps 0x945207a7
#SYMVER sock_set_keepalive 0x0beb0397
#SYMVER sock_set_rcvbuf 0xa31e2e15
#SYMVER sock_set_mark 0x038d1cb8
#SYMVER sockopt_lock_sock 0x1849dbe8
#SYMVER sockopt_release_sock 0x801e894d
#SYMVER sockopt_ns_capable 0x783247be
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x33b197c8
#SYMVER sk_alloc 0x5f258127
#SYMVER sk_free 0x36c091de
#SYMVER sk_clone_lock 0xbf285e7e
#SYMVER sk_free_unlock_clone 0xc8d2011d
#SYMVER sk_setup_caps 0x581978af
#SYMVER sock_wfree 0x911e0a7c
#SYMVER skb_set_owner_w 0x1a8c0f81
#SYMVER skb_orphan_partial 0xe7052298
#SYMVER sock_rfree 0x1fad1a56
#SYMVER sock_efree 0x844c5de4
#SYMVER sock_pfree 0x97791338
#SYMVER sock_i_uid 0x4914275a
#SYMVER __sock_i_ino 0x9dce2ad0
#SYMVER sock_i_ino 0xa2a427b5
#SYMVER sock_wmalloc 0xd2937cf2
#SYMVER sock_kmalloc 0x44982fa1
#SYMVER sock_kfree_s 0x39aa8a59
#SYMVER sock_kzfree_s 0xe762aa40
#SYMVER sock_alloc_send_pskb 0x73da78ac
#SYMVER __sock_cmsg_send 0x6355cda5
#SYMVER sock_cmsg_send 0xe7140f35
#SYMVER skb_page_frag_refill 0xbb59dffb
#SYMVER sk_page_frag_refill 0xd2fda55c
#SYMVER __sk_flush_backlog 0x77e1509a
#SYMVER sk_wait_data 0x790c3085
#SYMVER __sk_mem_schedule 0xac7f6213
#SYMVER __sk_mem_reclaim 0x07c53999
#SYMVER sk_set_peek_off 0xbd5a5907
#SYMVER sock_no_bind 0xda733252
#SYMVER sock_no_connect 0x84b08e3b
#SYMVER sock_no_socketpair 0xf4ba9908
#SYMVER sock_no_accept 0x0de85399
#SYMVER sock_no_getname 0x9b8d9591
#SYMVER sock_no_ioctl 0x62e9cfe4
#SYMVER sock_no_listen 0x6f5598d1
#SYMVER sock_no_shutdown 0xafeaf674
#SYMVER sock_no_sendmsg 0x9f1bba9f
#SYMVER sock_no_sendmsg_locked 0xad6b4ac8
#SYMVER sock_no_recvmsg 0xc5a3d011
#SYMVER sock_no_mmap 0x1e54ba33
#SYMVER sk_send_sigurg 0xa44e6221
#SYMVER sk_reset_timer 0x5bdc508f
#SYMVER sk_stop_timer 0xa3794ec3
#SYMVER sk_stop_timer_sync 0xbed21215
#SYMVER sock_init_data_uid 0xcb0698ea
#SYMVER sock_init_data 0x242851e9
#SYMVER lock_sock_nested 0xf3eaf8a7
#SYMVER release_sock 0xa5bdee8c
#SYMVER __lock_sock_fast 0xb0de7a43
#SYMVER sock_gettstamp 0x960990a1
#SYMVER sock_recv_errqueue 0xd5d41543
#SYMVER sock_common_getsockopt 0xebe48bde
#SYMVER sock_common_recvmsg 0x246cf6ad
#SYMVER sock_common_setsockopt 0xa8a6dd54
#SYMVER sk_common_release 0xbe478f6a
#SYMVER sock_prot_inuse_get 0x77d03f16
#SYMVER sock_inuse_get 0xb1fd90dc
#SYMVER proto_register 0x910bb85d
#SYMVER proto_unregister 0x7222c16a
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0xca6a0afb
#SYMVER sock_ioctl_inout 0x12635d9b
#SYMVER sk_ioctl 0x3611cec5
