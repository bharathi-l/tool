...
static int iwl_send_rss_cfg_cmd(struct iwl_mvm *mvm)
{
	...
	printk("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : RSS_CONFIG_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
...
static int iwl_mvm_send_dqa_cmd(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : WIDE_ID(DATA_PATH_GROUP, DQA_ENABLE_CMD)\n", __func__, __LINE__);
...
static void iwl_mvm_uats_init(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : WIDE_ID(REGULATORY_AND_NVM_GROUP,UATS_TABLE_CMD)\n", __func__, __LINE__);
...
static int iwl_mvm_sgom_init(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : WIDE_ID(REGULATORY_AND_NVM_GROUP,SAR_OFFSET_MAPPING_TABLE_CMD)\n", __func__, __LINE__);
	ret = iwl_mvm_send_cmd(mvm, &cmd);
	if (ret < 0)
...
static int iwl_send_phy_cfg_cmd(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : PHY_CONFIGURATION_CMD\n", __func__, __LINE__);
...
static int iwl_run_unified_mvm_ucode(struct iwl_mvm *mvm)
{
	...
	printk("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(REGULATORY_AND_NVM_GROUP,NVM_ACCESS_COMPLETE)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
...
static int iwl_mvm_config_ltr(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : LTR_CONFIG\n", __func__, __LINE__);
...
int iwl_mvm_sar_select_profile(struct iwl_mvm *mvm, int prof_a, int prof_b)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : REDUCE_TX_POWER_CMD\n", __func__, __LINE__);
...
int iwl_mvm_get_sar_geo_profile(struct iwl_mvm *mvm)
{
	...
	printk("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : PER_CHAIN_LIMIT_OFFSET_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	ret = iwl_mvm_send_cmd(mvm, &cmd);
	if (ret) {
...
static int iwl_mvm_sar_geo_init(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : WIDE_ID(PHY_OPS_GROUP, PER_CHAIN_LIMIT_OFFSET_CMD)\n", __func__, __LINE__);
...
int iwl_mvm_ppag_send_cmd(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : WIDE_ID(PHY_OPS_GROUP,PER_PLATFORM_ANT_GAIN_CMD)\n", __func__, __LINE__);
...
static void iwl_mvm_tas_init(struct iwl_mvm *mvm)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : WIDE_ID(REGULATORY_AND_NVM_GROUP, TAS_CONFIG)\n", __func__, __LINE__);
...
void iwl_mvm_send_recovery_cmd(struct iwl_mvm *mvm, u32 flags)
{
	...
	printk("%s %d : iwl_mvm_send_cmd : WIDE_ID(SYSTEM_GROUP, FW_ERROR_RECOVERY_CMD)\n", __func__, __LINE__);
