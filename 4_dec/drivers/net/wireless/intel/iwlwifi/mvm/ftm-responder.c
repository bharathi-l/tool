			  ...
			  struct ieee80211_bss_conf *link_conf)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(LOCATION_GROUP, TOF_RESPONDER_CONFIG_CMD)\n", __func__, __LINE__);
				 ...
				 struct ieee80211_ftm_responder_params *params)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(LOCATION_GROUP, TOF_RESPONDER_DYN_CONFIG_CMD)\n", __func__, __LINE__);
