			 ...
			 u32 flags, u16 len, const void *data)
{
	...
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : REPLY_SF_CFG_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : TX_ANT_CONFIGURATION_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : BT_CONFIG] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(PHY_OPS_GROUP,TEMP_REPORTING_THRESHOLDS_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : POWER_TABLE_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(MAC_CONF_GROUP, MAC_CONFIG_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : REPLY_BEACON_FILTERING_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(MAC_CONF_GROUP, LINK_CONFIG_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : ECHO_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : MAC_PM_POWER_TABLE] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : PHY_CONTEXT_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : iwl_cmd_id(RLC_CONFIG_CMD,DATA_PATH_GROUP, 2)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(DATA_PATH_GROUP, TLC_MNG_CONFIG_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(MAC_CONF_GROUP, SESSION_PROTECTION_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(MAC_CONF_GROUP, STA_CONFIG_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : WIDE_ID(DATA_PATH_GROUP, SEC_KEY_CMD)] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
				...
				const void *data, u32 *status)
{
	...
	pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : ] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
...
int iwl_mvm_send_lq_cmd(struct iwl_mvm *mvm, struct iwl_lq_cmd *lq)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : LQ_CMD\n", __func__, __LINE__);
	return iwl_mvm_send_cmd(mvm, &cmd);
}
					     ...
					     u8 cmd_ver)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(SYSTEM_GROUP, SYSTEM_STATISTICS_CMD)\n", __func__, __LINE__);
...
int iwl_mvm_request_statistics(struct iwl_mvm *mvm, bool clear)
{
	...
	if (iwl_fw_lookup_notif_ver(mvm->fw, LEGACY_GROUP,
		...
		pr_info("[MODULE -> %s], [THREAD -> %s] [iwl_mvm_send_cmd : STATISTICS_CMD] [%s] [%d]\n", THIS_MODULE->name, get_thread_name(), __func__, __LINE__);
		ret = iwl_mvm_send_cmd(mvm, &cmd);
		if (ret)
			return ret;
				  ...
				  bool low_latency, u16 mac_id)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(MAC_CONF_GROUP, LOW_LATENCY_CMD)\n", __func__, __LINE__);
