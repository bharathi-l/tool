					     ...
					     size_t count, loff_t *ppos)
{
	...
	mutex_lock(&mvm->mutex);
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(DEBUG_GROUP, GET_TAS_STATUS)\n", __func__, __LINE__);
					  ...
					  size_t count, loff_t *ppos)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(LONG_GROUP, REPLY_ERROR)\n", __func__, __LINE__);
					       ...
					       loff_t *ppos)
{
	...
	mutex_lock(&mvm->mutex);
	if (iwl_mvm_firmware_running(mvm)) {
		pr_info("%s %d : iwl_mvm_send_cmd : RSS_CONFIG_CMD\n", __func__, __LINE__);
			      ...
			      size_t count, loff_t *ppos)
{
	...
	mutex_lock(&mvm->mutex);
	pr_info("%s %d : iwl_mvm_send_cmd : ECHO_CMD\n", __func__, __LINE__);
				  ...
				  size_t count, loff_t *ppos)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(DATA_PATH_GROUP, HE_AIR_SNIFFER_CONFIG_CMD)\n", __func__, __LINE__);
