				       ...
				       struct iwl_time_event_cmd *te_cmd)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : TIME_EVENT_CMD\n", __func__, __LINE__);
			...
			int duration, u32 activity)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(MAC_CONF_GROUP, ROC_CMD)\n", __func__, __LINE__);
					 ...
					 enum ieee80211_roc_type type)
{
	...
	pr_info("%s %d : iwl_mvm_send_cmd : WIDE_ID(MAC_CONF_GROUP, SESSION_PROTECTION_CMD)\n", __func__, __LINE__);
